"""Black-box validation suite from the challenge README."""
...
@pytest.mark.asyncio
async def test_classification_flow(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_persistence(client: AsyncClient, db_session) -> None:
...
@pytest.mark.asyncio
async def test_stream_endpoint(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_graph_context() -> None:
